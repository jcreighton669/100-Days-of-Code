...
unknown_button = Button(image=x_mark_image, highlightthickness=0, command=next_card)
check_mark_button = Button(image=check_mark_image, highlightthickness=0, command=card_known)
