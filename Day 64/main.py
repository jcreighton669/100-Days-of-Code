...
MOVIE_API_KEY = "82645c2bcdaf7869b43df2ac029db824"
MOVIE_SEARCH_URL = "https://api.themoviedb.org/3/search/movie"
MOVIE_INFO_URL = "https://api.themoviedb.org/3/movie"
MOVIE_IMG_URL = "https://imame.tmdb.org/t/p/w500"
...
def add_movie():
	...
	if form.validate_on_submit():
		...
		response = requests.get(MOVIE_SEARCH_URL, params={"api_key": MOVIE_API_KEY, "query": movie_title})
